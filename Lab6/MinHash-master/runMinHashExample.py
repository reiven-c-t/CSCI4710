...
numDocs = 100
dataFile = "/Users/reiven/Documents/Python/CSCI4710/Lab6/MinHash-master/data/articles_" + str(numDocs) + ".train"
truthFile = "/Users/reiven/Documents/Python/CSCI4710/Lab6/MinHash-master/data/articles_" + str(numDocs) + ".truth"
...
for i in range(0, numDocs):
  ...
  for index in range(0, len(words) - 2):
    ...
    crc = int(binascii.crc32(bytes(shingle.encode("utf-8")))) & 0xffffffff
